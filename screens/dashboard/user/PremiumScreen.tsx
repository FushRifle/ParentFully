...
import { Button, Card, H4, H6, Text, XStack, YStack } from 'tamagui';
        ...
        <GoalBackground>
            <ScrollView style={{ flex: 1, }}>
                <YStack padding="$4" space="$4">
                    ...
                    <YStack alignItems="center" space="$2" marginBottom="$4" mt='$3'>
                        ...
                        <Text fontSize="$5" color={colors.text} textAlign="center" marginTop="$2">
                    ...
                    <YStack space="$3">
                        {/* Monthly Plan */}
                        <Card padding="$4" borderRadius="$4" backgroundColor={colors.card}>
                            <YStack space="$2">
                                <Text fontSize="$5" color={colors.text}>
                                    Monthly
                                </Text>
                                <H4 fontWeight="bold" color={colors.text}>
                                    $9.99 /month
                                </H4>
                                <Button
                    ...
                    <Button
                        ...
                        pressStyle={{ opacity: 0.8 }}
                    >
                        <Text color={colors.text}> Subscribe</Text>
                    </Button>

export const COUNTRY_CODES = [
    ...
    { code: "+855", country: "KH" },
    { code: "+237", country: "CM" },
    { code: "+1", country: "US" }, // include US only once
    { code: "+238", country: "CV" },
    ...
    { code: "+962", country: "JO" },
    { code: "+7", country: "RU" }, // keep Russia only once
    { code: "+254", country: "KE" },
    { code: "+686", country: "KI" },
    { code: "+383", country: "XK" },
    { code: "+965", country: "KW" },
    ...
    { code: "+856", country: "LA" },
    { code: "+371", country: "LV" },
    { code: "+961", country: "LB" }, // fixed Lebanon
    { code: "+266", country: "LS" },
    { code: "+231", country: "LR" },
    { code: "+218", country: "LY" },
    { code: "+423", country: "LI" },
    ...
    { code: "+212", country: "MA" }, // Morocco only once
    { code: "+258", country: "MZ" },
    { code: "+95", country: "MM" },
    { code: "+264", country: "NA" },
    { code: "+674", country: "NR" },

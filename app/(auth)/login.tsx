...
export default function LoginScreen() {
    ...
    const handleForgotPassword = async () => {
        ...
        try {
            ...
            Alert.alert('Password Reset Sent', `Check your email (${email}) for the reset link`)
        } catch (err) {
                ...
                >
                    <YStack flex={1} p="$5" space="$4" maw={600} alignSelf="center" w="100%" mt="$8">
                        ...
                        <YStack space="$3">
                            ...
                            {/* Email */}
                            <YStack space="$2">
                                <Text fontSize="$4" color={colors.text} fontWeight="600">Email Address</Text>
                                <XStack
                                    borderWidth={1}
                                    borderColor={colors.border as any}
                                    borderRadius="$4"
                            ...
                            {/* Password */}
                            <YStack space="$1">
                                <Text fontSize="$4" color={colors.text} fontWeight="600">Password</Text>
                                <XStack
                                    borderWidth={1}
                                    borderColor={colors.border as any}
                                    borderRadius="$4"
                            ...
                            <XStack ai="center" jc="space-between" mt="$2">
                                <XStack ai="center" space="$3">
                                    <Checkbox size="$4" id="remember" checked={rememberMe} onCheckedChange={(val) => setRememberMe(!!val)} borderColor={colors.border as any} backgroundColor="white">
                                        <Checkbox.Indicator backgroundColor={colors.secondary} />
                                    </Checkbox>
